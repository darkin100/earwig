...
/// The app's entire entry flow — headless CLI modes and the menu bar app.
/// Lives in the library so the executable stays a two-line shim and tests
/// can link the same module.
public enum EarwigMain {
